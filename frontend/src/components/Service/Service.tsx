...
function Service(props: ServiceProps) {
    return (
        <Stack direction='row' justifyContent='space-between' sx={{ padding: '14px 0px 14px 0px', borderBottom: '1px solid #EBEBEB' }}>
            ...
            <Stack direction='row' alignItems='center' justifyContent='space-between' sx={{ width: '130px' }}>
                <Stack direction='column'>
                ...
                <Button variant='contained' onClick={props.onClick} sx={{ backgroundColor: 'rgb(33, 140, 172)', ':hover': { backgroundColor: 'rgb(33, 140, 172)' } }}>Umów</Button>
            </Stack>
        </Stack>
    )
}
