...
import com.example.demo.service.SingleServiceRepository;
...
public class VisitService {
    ...
    private final SingleServiceRepository serviceRepository;
    ...
    public Visit makeAReservation(Visit visit) throws NotFoundException {
        ...
        // Przypisanie pobranych obiektów do pól visit
...
//        return token;
    ...
    public List<Visit> specificUserVisits(Long id) {
        //visitRepository.findAllById()
        return visitRepository.findByClientId(id);
    }

    public List<Visit> specificEmployeeVisits(Long id) {
        //visitRepository.findAllById()
        return visitRepository.findByEmployeeId(id);
    }
